...
# revere rmse
for dataset in c28orig_dict.keys():
    c28orig_dict[dataset]["rmse"] = 1.0 / c28orig_dict[dataset]["rmse"]
for dataset in c28scratch_dict.keys():
    c28scratch_dict[dataset]["rmse"] = 1.0 / c28scratch_dict[dataset]["rmse"]
for dataset in c28aug_dict.keys():
    c28aug_dict[dataset]["rmse"] = 1.0 / c28aug_dict[dataset]["rmse"]

dicts = {"orig": c28orig_dict, "scratch": c28scratch_dict, "aug": c28aug_dict}

colors = {"orig": "#8A5300", "scratch": "#00C379", "aug": "#9600C2"}
markers = {"orig": "o", "scratch": "^", "aug": "*"}
...
# plot labels
labels = {
    "orig": "C2878 (SS Pretrained)",
    "scratch": "C2878 Aug (no SS Pretraining)",
    "aug": "C2878 Aug (SS Pretrained)",
}
for name in ["orig", "scratch", "aug"]:
    fig.gca().plot(
        range(10),
        pylab.randn(10),
        marker=markers[name],
